...
pub fn lookup(codec_id: &str) -> Option<MatroskaCodec> {
  ...
  TABLE.iter().copied().find(|e| e.prefix && codec_id.starts_with(e.id))
}
...
const TABLE: &[MatroskaCodec] = &[
  ...
  MatroskaCodec {
    id: "V_MPEG4/ISO/AP",
    name: "MPEG-4p2 advanced profile",
    kind: TrackKind::Video,
    prefix: false,
  },
  MatroskaCodec {
    id: "V_MPEG4/ISO/ASP",
    name: "MPEG-4p2 advanced simple profile",
    kind: TrackKind::Video,
    prefix: false,
  },
  MatroskaCodec {
    id: "V_MPEG4/ISO/AVC",
    name: "AVC/H.264/MPEG-4p10",
    kind: TrackKind::Video,
    prefix: false,
  },
  MatroskaCodec {
    id: "V_MPEG4/ISO/SP",
    name: "MPEG-4p2 simple profile",
    kind: TrackKind::Video,
    prefix: false,
  },
  MatroskaCodec {
  ...
  MatroskaCodec {
    id: "V_MPEGH/ISO/HEVC",
    name: "HEVC/H.265/MPEG-H p2",
    kind: TrackKind::Video,
    prefix: false,
  },
  MatroskaCodec {
    id: "V_MS/VFW/FOURCC",
    name: "VfW compatibility (FourCC)",
    kind: TrackKind::Video,
    prefix: false,
  },
  MatroskaCodec {
  ...
  MatroskaCodec {
    id: "A_AAC/MPEG2/LC/SBR",
    name: "AAC LC SBR (MPEG-2)",
  ...
  MatroskaCodec {
    id: "A_AAC/MPEG4/LC/SBR",
    name: "AAC LC SBR (MPEG-4)",
    kind: TrackKind::Audio,
    prefix: false,
  },
  MatroskaCodec {
  ...
  MatroskaCodec {
    id: "A_PCM/INT/BIG",
    name: "PCM (signed integer, big-endian)",
    kind: TrackKind::Audio,
    prefix: false,
  },
  MatroskaCodec {
    id: "A_PCM/INT/LIT",
    name: "PCM (signed integer, little-endian)",
    kind: TrackKind::Audio,
    prefix: false,
  },
  MatroskaCodec {
  ...
  MatroskaCodec {
    id: "S_TEXT/ASCII",
    name: "ASCII text subtitles",
    kind: TrackKind::Subtitle,
    prefix: false,
  },
  MatroskaCodec {
    id: "S_TEXT/ASS",
    name: "SubStationAlpha (ASS)",
    kind: TrackKind::Subtitle,
    prefix: false,
  },
  MatroskaCodec {
    id: "S_TEXT/SSA",
    name: "SubStationAlpha (SSA)",
    kind: TrackKind::Subtitle,
    prefix: false,
  },
  MatroskaCodec {
